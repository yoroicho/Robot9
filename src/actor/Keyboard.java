...
public class Keyboard {
    ...
    private final Long SLEEP_WAIT = 50L;
    ...
    public synchronized void doTyping(String letter) throws Exception {
        Keyboard keyboard = new Keyboard();
        robot.delay(500);
    ...
    private void doType(int[] keyCodes, int offset, int length) {
        ...
        /*
        if (keyCodes[offset] == VK_UNDERSCORE) { // '_' for Windows
            robot.delay(1000);
        ...
        */
        if (keyCodes[offset] == VK_UNDERSCORE){
